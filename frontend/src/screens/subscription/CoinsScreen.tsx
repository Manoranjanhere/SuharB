  ...
  return (
    <ScrollView style={[styles.container, { paddingTop: insets.top }]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.spendSection}>
        ...
        <Text style={styles.sectionSubtitle}>After your daily plan quota is used up:</Text>
        {[
          { icon: '⭐', label: 'Super Like', cost: '1 coin', desc: 'Stand out in Liked By + optional message' },
          { icon: '💬', label: 'Message New Profile', cost: '1 coin', desc: 'Send 1 extra chat message' },
          { icon: '💝', label: 'Compliment', cost: '1 coin', desc: 'Send a compliment with your like' },
        ].map((item) => (
